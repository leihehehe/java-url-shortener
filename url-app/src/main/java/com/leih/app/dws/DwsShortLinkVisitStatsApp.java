package com.leih.app.dws;

import com.fasterxml.jackson.databind.node.ObjectNode;
import com.leih.app.model.ShortLinkDetail;
import com.leih.app.model.ShortLinkVisitStats;
...
public class DwsShortLinkVisitStatsApp {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // Aggregation
      SingleOutputStreamOperator<Object> reduceDS = windowedStream.reduce(
              new ReduceFunction<ShortLinkVisitStats>() {
                  @Override
                  public ShortLinkVisitStats reduce(
                          ShortLinkVisitStats shortLinkVisitStats, ShortLinkVisitStats t1) throws Exception {
