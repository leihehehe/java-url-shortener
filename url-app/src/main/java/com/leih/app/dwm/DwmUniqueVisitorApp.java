...
import com.leih.app.func.UniqueVisitorFilterFunction;
...
public class DwmUniqueVisitorApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<ObjectNode> jsonDS = ds.map(jsonStr -> JsonUtil.json2Obj(jsonStr, ObjectNode.class));
        //group
        KeyedStream<ObjectNode, String> keyedStream = jsonDS.keyBy(new KeySelector<ObjectNode, String>() {
            @Override
        ...
        //remove duplicates
        SingleOutputStreamOperator<ObjectNode> filterDS = keyedStream.filter(new UniqueVisitorFilterFunction());
