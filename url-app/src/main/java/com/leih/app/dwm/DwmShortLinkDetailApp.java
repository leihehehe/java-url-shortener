...
import com.leih.app.func.AsyncIpLocationFunction;
...
public class DwmShortLinkDetailApp {
  ...
  public static void main(String[] args) throws Exception {
    ...
    SingleOutputStreamOperator<String> detailDS= AsyncDataStream.unorderedWait(deviceDS,new AsyncIpLocationFunction(),3000, TimeUnit.MILLISECONDS,100);
