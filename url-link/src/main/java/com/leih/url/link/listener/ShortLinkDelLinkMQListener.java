...
public class ShortLinkDelLinkMQListener {
    ...
    public void shortLinkHandler(EventMessage eventMessage, Message message, Channel channel) throws IOException {
        ...
        try{
            eventMessage.setEventMessageType(EventMessageTypeEnum.SHORT_LINK_DELETE_LINK.name());
        ...
        log.info("Successfully consumed the message by ShortLinkDelLinkMQListener: {}",eventMessage);
