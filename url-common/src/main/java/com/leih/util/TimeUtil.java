...
public class TimeUtil {
     ...
     * This method is used for configuring the expiration time of data
     * @param currentDate
     * @return
     */
    public static Integer getSecondsLeftInTheDay(Date currentDate) {
        LocalDateTime midnight =
                LocalDateTime.ofInstant(currentDate.toInstant(),ZoneId.systemDefault()).plusDays(1).withHour(0).withMinute(0).withSecond(0).withNano(0);
